...
/// <summary>Projection parsed out of a client-PUT vCard. For <c>Profiles</c>/<c>Deceased</c>/<c>EmergencyContactIds</c>/<c>Notes</c>/<c>Pronouns</c>,
...
public sealed record ParsedContact(
    ...
    string? Notes = null, string? Pronouns = null);
