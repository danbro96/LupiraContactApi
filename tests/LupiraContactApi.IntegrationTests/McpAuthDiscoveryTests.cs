...
public sealed class McpAuthDiscoveryTests(ContactApiTestFactory factory) : IntegrationTest(factory)
{
    [Theory]
    ...
    public async Task Metadata_is_anonymous_and_names_the_issuer(string path)
    {
        ...
        Assert.Equal(["https://auth.test/application/o/lupira-contact/"], servers);
